library(brms); library(flocker)

fd <- readRDS("outputs/fd.rds")
...
prior_specification <- c(
    ...
    set_prior("normal(0,3)", dpar = "occ", coef = "once_logged:forestdep_high"),
    set_prior("normal(0,3)", dpar = "occ", coef = "once_logged:forestdep_med"),
    set_prior("normal(0,3)", dpar = "occ", coef = "once_logged:forestdep_low"),
    set_prior("normal(0,3)", dpar = "occ", coef = "primary:forestdep_high"),
    set_prior("normal(0,3)", dpar = "occ", coef = "primary:forestdep_med"),
    set_prior("normal(0,3)", dpar = "occ", coef = "primary:forestdep_low"),
    set_prior("normal(0,3)", dpar = "occ", coef = "twice_logged:forestdep_high"),
